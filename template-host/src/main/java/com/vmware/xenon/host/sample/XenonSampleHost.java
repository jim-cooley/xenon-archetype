...
package com.vmware.xenon.host.sample;
 ...
 */
public class XenonSampleHost extends ServiceHost {

    public static void main(String[] args) throws Throwable {
        XenonSampleHost h = new XenonSampleHost();
        h.initialize(args);
        h.start();
    ...
    private void startSwaggerDescriptorService() {
        ...
        apiInfo.setTitle("Xenon Sample Host");
